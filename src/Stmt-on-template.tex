...
{\centering \includegraphics[width=7.3307in,height=7in]{\VAR{report_directory}report_\VAR{plan_name}_diff_map.pdf} \par}
...
\begin{figure*}[h]{\centering \includegraphics[width=7.3307in,height=3.9472in]{\VAR{plots_directory}racial-political-deviations-\VAR{chamber}-\VAR{plan}-PRES20-BVAP.pdf} \par}\end{figure*}
\begin{figure*}[h]{\centering \includegraphics[width=7.3307in,height=3.9472in]{\VAR{plots_directory}racial-political-deviations-\VAR{chamber}-\VAR{plan}-PRES20-HVAP.pdf} \par}\end{figure*}
\begin{figure*}[h]{\centering \includegraphics[width=7.3307in,height=3.9472in]{\VAR{plots_directory}racial-political-deviations-\VAR{chamber}-\VAR{plan}-PRES20-BHVAP.pdf} \par}\end{figure*}
\begin{figure*}[h]{\centering \includegraphics[width=7.3307in,height=3.9472in]{\VAR{plots_directory}racial-political-deviations-\VAR{chamber}-\VAR{plan}-PRES20-NWVAP.pdf} \par}\end{figure*}

\begin{figure*}[h]{\centering \includegraphics[width=7.3307in,height=3.9472in]{\VAR{plots_directory}racial-political-deviations-\VAR{chamber}-\VAR{plan}-SEN20-BVAP.pdf} \par}\end{figure*}
\begin{figure*}[h]{\centering \includegraphics[width=7.3307in,height=3.9472in]{\VAR{plots_directory}racial-political-deviations-\VAR{chamber}-\VAR{plan}-SEN20-HVAP.pdf} \par}\end{figure*}
\begin{figure*}[h]{\centering \includegraphics[width=7.3307in,height=3.9472in]{\VAR{plots_directory}racial-political-deviations-\VAR{chamber}-\VAR{plan}-SEN20-BHVAP.pdf} \par}\end{figure*}
\begin{figure*}[h]{\centering \includegraphics[width=7.3307in,height=3.9472in]{\VAR{plots_directory}racial-political-deviations-\VAR{chamber}-\VAR{plan}-SEN20-NWVAP.pdf} \par}\end{figure*}
\end{document}
