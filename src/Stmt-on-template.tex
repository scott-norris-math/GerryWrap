...
{\centering \includegraphics[width=6.5in,height=3.5in]{\VAR{plots_directory}violin-plot-\VAR{chamber}-\VAR{original_plan_mask}-\VAR{plan}-\VAR{racial_group}-CVAP-mggg_eff_\VAR{model}.pdf} \par}
\BLOCK{ endfor }
\BLOCK{ endfor }
